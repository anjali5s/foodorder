...
$sql = "SELECT orders.*, products.image, category_id, product_name FROM orders 
        JOIN products ON orders.product_id = product.id 
        JOIN category ON product_id = category.id 
